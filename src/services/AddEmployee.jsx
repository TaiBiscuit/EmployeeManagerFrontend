...
export const AddEmployee = () => {
    ...
    function submitForm(e){
        ...
        let role = parseInt(document.getElementById('rol').value);
    ...
    <div className="addemployee-container">
        <form id="form" onSubmit={(e) => submitForm(e)}>
            <div className="firstName form-div">
                <label htmlFor="firstName" className="contact-label">Employee first name</label>
                <input name="firstName" type="text" className="contact-input" id="fname" required/>
            </div>
            <div className="lastName  form-div">
                <label htmlFor="lastName" className="contact-label">Employee last name</label>
            ...
            <input type="submit" value="Create Employee" id="form-btn" className="form-btn" />
            </div>
        </form>
